...
export class UserService implements OnInit{
  ...
  async forgetPasswordSendMail(req: Req, res: Res, body: any){
    try{
      ...
      const mailOptions = {
        ...
        <div align="center" class="alignment" style="line-height:10px"><img src="https://acq-staging.netlify.app/static/image/icons/email.png" style="display: block; height: auto; border: 0; width: 100px; max-width: 100%;" width="100"/></div>
        </td>
        </tr>
        </table>
  ...
  async resetPassword(req: Req, res: Res, body: any) {
    try{
      ...
      let user = await this.User.findOne({emailOTP: body.otp.toUpperCase()}).select("+emailOTP");
